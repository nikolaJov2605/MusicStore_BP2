...
namespace ServiceLayer.Models.Instruments
{
    public class KlavijaturaModel : InstrumentModel
    {
        ...
        private string vrstaKlavijature;
        ...
        public KlavijaturaModel(string naziv, string proizvodjac, string opis, string tipInstrumenta, double cena, int sirina,
            int duzina, int dubina, int masa, int brojTonova, string vrstaKlavijature) : base(naziv, proizvodjac, opis, tipInstrumenta, cena)
        {
            this.Sirina = sirina;
            this.Duzina = duzina;
            this.Dubina = dubina;
            ...
            this.VrstaKlavijature = vrstaKlavijature;
        }
        ...
        public string VrstaKlavijature { get => vrstaKlavijature; set => vrstaKlavijature = value; }
    }
}
